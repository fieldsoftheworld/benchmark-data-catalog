...
This is a sub-catalog of chips in MGRS 100 km square 32ULV. See the [collection agent guide](../../AGENTS.md) for the full collection.
...
```sql
SELECT * FROM read_parquet('../../items.parquet') WHERE id LIKE 'ftw-32ULV%';
```
