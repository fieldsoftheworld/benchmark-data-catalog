# Austria — MGRS square 32TQT

## Overview

This is a sub-catalog of chips in MGRS 100 km square 32TQT. See the [collection agent guide](../../AGENTS.md) for the full collection.
...
```sql
SELECT * FROM read_parquet('../../items.parquet') WHERE id LIKE 'ftw-32TQT%';
```
