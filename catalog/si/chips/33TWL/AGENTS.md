# Slovenia — MGRS square 33TWL

## Overview

This is a sub-catalog of chips in MGRS 100 km square 33TWL. See the [collection agent guide](https://source.coop/ftw/benchmark-data/si/AGENTS.md) for the full collection.
...
```sql
SELECT * FROM read_parquet('https://data.source.coop/ftw/benchmark-data/si/items.parquet') WHERE id LIKE 'ftw-33TWL%';
```
